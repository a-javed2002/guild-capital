...
function Home() {
    ...
    useEffect(() => {
      const handleScroll = () => {
        ...
        setIsFullScreen(scrollTop < 100); // Adjust threshold as needed
      };
...
i want you know page start with zero scroll so i want when page open this vedio take 100% width,height basically capture fuul screens z-index
then when i scroll with transition vedio back to normal just like current with transition hight wth decrease 
